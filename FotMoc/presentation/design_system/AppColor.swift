...
public enum AppColor {
    ...
    public static let bgPrimary = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#0D0D0F") : UIColor(hex: "#F8F9FA")
    }
    
    public static let bgSurface = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#161618") : UIColor(hex: "#FFFFFF")
    }
    
    public static let bgSurface2 = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#1E1E22") : UIColor(hex: "#F1F2F4")
    }
    
    public static let bgSurface3 = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#252529") : UIColor(hex: "#E8E9EC")
    }

    public static let textPrimary = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#F5F5F5") : UIColor(hex: "#0D0D0F")
    }
    
    public static let textSecondary = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#9A9A9A") : UIColor(hex: "#5E5E62")
    }
    
    public static let textTertiary = UIColor { trait in
        trait.userInterfaceStyle == .dark ? UIColor(hex: "#5E5E62") : UIColor(hex: "#9A9A9A")
    }

    public static let border = UIColor { trait in
        trait.userInterfaceStyle == .dark ?
        UIColor(white: 1.0, alpha: 0.07) : UIColor(white: 0.0, alpha: 0.08)
    }
}
