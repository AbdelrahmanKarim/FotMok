...
class LiveMatchesViewController: UIViewController {
    ...
    private func registerCells() {
        collectionView.register(UINib(nibName: "LiveMatchesCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "liveMatchCell")
...
extension LiveMatchesViewController: LiveMatchesView {
    ...
    func displayEmptyState() {
        ...
        emptyCell.configure(message: NSLocalizedString("empty_no_live", comment: ""), iconName: "antenna.radiowaves.left.and.right.slash")
...
extension LiveMatchesViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int { matches.count }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "liveMatchCell", for: indexPath) as! LiveMatchesCollectionViewCell
...
extension LiveMatchesViewController: SkeletonCollectionViewDataSource {
    ...
    func collectionSkeletonView(_ skeletonView: UICollectionView, numberOfItemsInSection section: Int) -> Int { 4 }
